...
public:
    ...
    ~addebook() {
        ...
        cout << "Book with ID " << book_id << " is being removed.\n";
    }
    ...
    static void searchBook(addebook* books, int book_count) {
        if (book_count == 0) {
...
public:
    ...
    ~borrow() {
        ...
        cout << "Borrow record for user ID " << user_id << " is being removed.\n";
    }
...
int main() {
    addebook* books = new addebook[MAX_BOOKS]; 
    borrow* borrows = new borrow[MAX_BORROWS]; 
    ...
    while (true) {
        ...
        if (choice == 1) {
            ...
            addebook::searchBook(books, book_count);
        } else if (choice == 9) {
            cout << "Thank You!\n";
            break;
        } else {
